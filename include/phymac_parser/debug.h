...
PPSR_API void debug_assert_wrn(u32 line, const char* function, const char* file, u64 assertion, ...);
PPSR_API void debug_assert(u32 line, const char* function, const char* file, u64 assertion, ...);
PPSR_API void debug_logv(const char* description, u32 line, const char* function, const char* file, const char* format, va_list args);
PPSR_API void debug_log(const char* description, u32 line, const char* function, const char* file, const char* format, ...);
PPSR_API void debug_log_exit(const char* description, u32 line, const char* function, const char* file, const char* format, ...);
