...
#ifdef PMC_PARSER_STATIC_LIBRARY
#	define PMC_PARSER_API
#elif PMC_PARSER_DYNAMIC_LIBRARY
#	define PMC_PARSER_API __declspec(dllimport)
#elif BUILD_DYNAMIC_LIBRARY
#	define PMC_PARSER_API __declspec(dllexport)
#else
#	define PMC_PARSER_API
#endif
